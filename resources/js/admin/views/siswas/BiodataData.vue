            ...
            <div class="row">
                ...
                <div class="col-8">
                    <table class="w-100 table-biodata">
                        ...
                        <tr-biodata label="Password" :value="siswa.password_show" v-if="$can(['admin','operator']) || hasPassword()" />
...
<script>
import TrBiodata from "./TrBiodata.vue";
import TableOrtu from "./TableOrtu.vue";
import TrFile from "./TrFile.vue";
...
export default {
    ...
    methods:{
        getData(){
            ...
            let url = app.$api(app.url_api+'/'+siswa+'/biodata/data');
            app.$http.get(url,{
        ...
        hasPassword(){
            if ( this.$hasWalikelas() ) {
                return this.$config.walikelas.id == this.siswa.kelas_id;
            } else {
                return false;
            }
        }
