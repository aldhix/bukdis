...
class VueEdit extends Command
{
     ...
     * @var string
     */
    protected $signature = 'vue:edit {name}';
     ...
     * @var string
     */
    protected $description = 'Membuat file Edit/ Ubah Vue.js';
    ...
    {
        $keterangan = "Edit Vue.js";
        $format = 'FormatAdminEdit';
