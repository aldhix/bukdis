...
class VueList extends Command
{
     ...
     * @var string
     */
    protected $signature = 'vue:list {name}';
     ...
     * @var string
     */
    protected $description = 'Membuat file List / Daftar Vue.js';
    ...
    {
        $keterangan = "List Vue.js";
        $format = 'FormatAdminList';
