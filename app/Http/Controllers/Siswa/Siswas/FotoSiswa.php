...
class FotoSiswa extends Controller
{
    public function upload(SiswaFotoUpload $request, $ortu = null)
    {
        $siswa = Auth::user();
        ...
        return ['filename'=>UrlFileHelper::get($siswa,'thumb_'.$filename,'siswa')];
    }
}
